...
- [x] 🦠 [Teste EICAR (arquivo de teste padrão de antivírus) — integração ClamAV + regra customizada](https://github.com/vick2715/test_03_eicar_clamav-homelab-wazuh-SIEM)
- [ ] 🌐 Port scan com Nmap
